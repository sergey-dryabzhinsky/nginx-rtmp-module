...
static ngx_command_t ngx_rtmp_hls_commands[] = {
    ...
    {ngx_string("hls"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                            NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, hls), NULL},

    {ngx_string("hls_fragment"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                     NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, fraglen), NULL},

    {ngx_string("hls_max_fragment"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                         NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, max_fraglen), NULL},

    {ngx_string("hls_path"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                 NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, path), NULL},

    {ngx_string("hls_playlist_length"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                            NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, playlen), NULL},

    {ngx_string("hls_muxdelay"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                     NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, muxdelay), NULL},

    {ngx_string("hls_sync"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                 NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, sync), NULL},

    {ngx_string("hls_continuous"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                       NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, continuous), NULL},

    {ngx_string("hls_nested"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                   NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, nested), NULL},

    {ngx_string("hls_fragment_naming"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                            NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
    ...
    {ngx_string("hls_datetime"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                     NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_enum_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, datetime), &ngx_rtmp_hls_datetime_slots},
    ...
    {ngx_string("hls_type"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                 NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_enum_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, type), &ngx_rtmp_hls_type_slots},

    {ngx_string("hls_max_audio_delay"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                            NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_msec_slot, NGX_RTMP_APP_CONF_OFFSET,
    ...
    {ngx_string("hls_cleanup"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                    NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
    ...
    {ngx_string("hls_variant"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                    NGX_RTMP_APP_CONF | NGX_CONF_1MORE,
     ngx_rtmp_hls_variant, NGX_RTMP_APP_CONF_OFFSET, 0, NULL},

    {ngx_string("hls_base_url"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                     NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
    ...
    {ngx_string("hls_keys"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                 NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_flag_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, keys), NULL},

    {ngx_string("hls_key_path"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                     NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
     offsetof(ngx_rtmp_hls_app_conf_t, key_path), NULL},

    {ngx_string("hls_key_url"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                    NGX_RTMP_APP_CONF | NGX_CONF_TAKE1,
     ngx_conf_set_str_slot, NGX_RTMP_APP_CONF_OFFSET,
...
static ngx_int_t ngx_rtmp_hls_write_playlist(ngx_rtmp_session_t *s)
{
    ...
    ngx_log_error(NGX_LOG_DEBUG, s->connection->log, 0, "hls: write playlist");
...
static ngx_int_t ngx_rtmp_hls_copy(ngx_rtmp_session_t *s, void *dst,
...
static ngx_int_t ngx_rtmp_hls_append_aud(ngx_rtmp_session_t *s, ngx_buf_t *out)
{
...
static uint64_t ngx_rtmp_hls_get_fragment_id(ngx_rtmp_session_t *s, uint64_t ts)
{
    ngx_rtmp_hls_ctx_t *ctx;
    ngx_rtmp_hls_app_conf_t *hacf;
...
static ngx_str_t *ngx_rtmp_hls_get_fragment_datetime(ngx_rtmp_session_t *s,
                                                     uint64_t ts)
{
    ngx_rtmp_hls_app_conf_t *hacf;
    ngx_str_t *datetime;
    ...
    case NGX_RTMP_HLS_DATETIME_TIMESTAMP:
        ...
        datetime->data = (u_char *)ngx_pcalloc(s->connection->pool,
    ...
    case NGX_RTMP_HLS_DATETIME_SYSTEM:
        datetime->data = (u_char *)ngx_pcalloc(s->connection->pool,
                                               ngx_cached_http_log_iso8601.len *
                                                   sizeof(u_char));
        ngx_memcpy(datetime->data, ngx_cached_http_log_iso8601.data,
                   ngx_cached_http_log_iso8601.len);
        datetime->len = ngx_cached_http_log_iso8601.len;
        return datetime;
                                            ...
                                            ngx_int_t discont)
{
    ...
    if (hacf->keys &&
        ngx_rtmp_mpegts_init_encryption(&ctx->file, ctx->key, 16,
                                        ctx->key_id) != NGX_OK) {
        ngx_log_error(NGX_LOG_ERR, s->connection->log, 0,
...
#define NGX_RTMP_MSEQ_LEN (sizeof(NGX_RTMP_MSEQ) - 1)
            ...
            if (ngx_memcmp(p, NGX_RTMP_MSEQ, NGX_RTMP_MSEQ_LEN) == 0) {
                ctx->frag =
                    (uint64_t)strtod((const char *)&p[NGX_RTMP_MSEQ_LEN], NULL);
    ...
    if (ctx->frags == NULL) {
        ctx->frags =
            ngx_pcalloc(s->connection->pool,
                        sizeof(ngx_rtmp_hls_frag_t) * (hacf->winfrags * 2 + 1));
        if (ctx->frags == NULL) {
            return NGX_ERROR;
        }
    }
        ...
        for (n = 0; n < hacf->variant->nelts; n++, var++) {
            if (ctx->name.len > var->suffix.len &&
                ...
                ctx->var_playlist.len =
                    len - var->suffix.len + sizeof(".m3u8") - 1;
                ...
                *pp = 0;
                ...
                ctx->var_playlist_bak.len =
                    ctx->var_playlist.len + sizeof(".bak") - 1;
                ctx->var_playlist_bak.data = ngx_palloc(
                    s->connection->pool, ctx->var_playlist_bak.len + 1);

                pp = ngx_cpymem(ctx->var_playlist_bak.data,
                                ctx->var_playlist.data, ctx->var_playlist.len);
                                         ...
                                         ngx_uint_t flush_rate)
{
    ...
    ngx_log_error(NGX_LOG_DEBUG, s->connection->log, 0, "hls: update fragment");
                                    ...
                                    ngx_chain_t *in)
{
    ...
    size = codec_ctx->audio_codec_id == NGX_RTMP_AUDIO_MP3 ? h->mlen - 1
                                                           : h->mlen - 2 + 7;
    ...
    if (codec_ctx->audio_codec_id == NGX_RTMP_AUDIO_AAC) {
        ...
        /* For some reason the pointer is already incremented past the rest
           ...
           being done.  Regardless, there's an extra byte that needs to be
           skipped
           for MP3. */
        in->buf->pos += 1;
    }
    ...
    samples_per_frame =
        codec_ctx->audio_codec_id == NGX_RTMP_AUDIO_AAC ? 1024 : 1152;

    est_pts =
        ctx->aframe_base +
        ctx->aframe_num * 90000 * samples_per_frame / codec_ctx->sample_rate;
...
{
    ngx_log_error(NGX_LOG_DEBUG, s->connection->log, 0, "hls: stream eof");
...
static ngx_int_t ngx_rtmp_hls_cleanup_dir(ngx_str_t *ppath, ngx_msec_t playlen)
{
    ngx_dir_t dir;
...
static ngx_int_t ngx_rtmp_hls_playlist(ngx_rtmp_session_t *s,
                                       ngx_rtmp_playlist_t *v)
{
    return next_playlist(s, v);
}
