...
static ngx_command_t ngx_rtmp_log_commands[] = {
    ...
    {ngx_string("access_log"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
                                   NGX_RTMP_APP_CONF | NGX_CONF_TAKE12,
     ngx_rtmp_log_set_log, NGX_RTMP_APP_CONF_OFFSET, 0, NULL},

    {ngx_string("log_format"), NGX_RTMP_MAIN_CONF | NGX_RTMP_SRV_CONF |
...
static u_char *ngx_rtmp_log_var_session_uint32_getdata(ngx_rtmp_session_t *s,
                                                       u_char *buf,
                                                       ngx_rtmp_log_op_t *op)
{
    uint32_t *v;
...
static void *ngx_rtmp_log_create_main_conf(ngx_conf_t *cf)
{
    ...
    if (ngx_array_init(&lmcf->formats, cf->pool, 4,
                       sizeof(ngx_rtmp_log_fmt_t)) != NGX_OK) {
        return NULL;
    }
